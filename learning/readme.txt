...
Uruchom kontener: docker run -p 8081:5000 trading-bot-api

Teraz Twoja aplikacja w Javie może wysyłać zapytania POST na
adres http://localhost:5000/predict z danymi w formacie JSON, a w odpowiedzi otrzyma decyzję modelu.